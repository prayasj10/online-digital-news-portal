            ...
            <div class="col-lg-8 col-md-8 col-sm-8">
                <div class="left_content">
                    <div class="single_page">
                        <ol class="breadcrumb">
                            <li><a href="/">Home</a></li>
                            {{--                            <li><a href="/{{$sport->slug}}">{{$sport->name}}</a></li>--}}
                            <li class="active">{{$sport->name}}</li>
                        </ol>
                        <h1>{{$post->title}}</h1>
                        <div class="post_commentbox"> <a href="/authors/{{$post->author->id}}"><i class="fa fa-user"></i>{{$post->author->name}}</a> <span><i class="fa fa-calendar"></i>6:49 AM</span> <a href="#"><i class="fa fa-tags"></i>{{$sport->name}}</a> </div>
                        ...
                        <div class="related_post">
                            ...
                            @foreach($relatedpost->posts as $index=>$post)
                                    @if($post->id != $id)
                                        @php($count++)
                                        <li>
                                            <div class="media"> <a class="media-left" href="/{{$sport->slug}}/{{$post->id}}">
                                                    @if($post->image)
                                                ...
                                                <div class="media-body"> <a class="catg_title" href=/{{$sport->slug}}/{{$post->id}}">{{$post->title}}</a> </div>
                                            </div>
                                        </li>
                                    @endif
                                    @if($count > 2)
