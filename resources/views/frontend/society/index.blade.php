            ...
            <div class="col-lg-8 col-md-8 col-sm-8">
                <div class="left_content">
                    <div class="single_page">
                        <ol class="breadcrumb">
                            <li><a href="/">Home</a></li>
                            <li class="active">{{$society->name}}</li>
                        </ol>


                        <div class="single_post_content">
                            <h2><span>societys</span></h2>
                            @foreach($societies as $society)
                                @foreach($society->posts as $posts)
                                    ...
                                    @if($loop->even)
                                        <div class="single_post_content_left">
                                            ...
                                            <ul class="business_catgnav  wow fadeInDown">
                                                <li>
                                                    <figure class="bsbig_fig"><a href="/{{$society->slug}}/{{$posts->id}}"
                                                                                 class="featured_img">
                                                            @if($posts->image)
                                                                <img alt="" src="storage/{{$posts->image}}">
                                                            @else
                                                                <img alt="" class="default" src="/frontend/posts/defaultPostImage.jpg">
                                                            @endif
                                                            <span class="overlay"></span> </a>
                                                        <figcaption><a
                                                                href="/{{$society->slug}}/{{$posts->id}}">{{$posts->title}}</a>
                                                        </figcaption>
                                                        <p>{!!$posts->content!!}</p>
                                                    </figure>
                                                </li>
...
{{--                                                        href="/{{$society->slug}}/{{$posts->id}}" class="media-left"> <img--}}
{{--                                                            alt="" src="storage/{{$posts->image}}"> </a>--}}
{{--                                                    <div class="media-body"><a href="/{{$society->slug}}/{{$posts->id}}"--}}
...
{{--                                <li>--}}
{{--                                    <div class="media"> <a class="media-left" href="single_page.html"> <img src="..//frontend/posts/post_img1.jpg" alt=""> </a>--}}
{{--                                        <div class="media-body"> <a class="catg_title" href="single_page.html"> Aliquam malesuada diam eget turpis varius</a> </div>--}}
{{--                                    </div>--}}
{{--                                </li>--}}
{{--                                <li>--}}
{{--                                    <div class="media"> <a class="media-left" href="single_page.html"> <img src="..//frontend/posts/post_img2.jpg" alt=""> </a>--}}
{{--                                        <div class="media-body"> <a class="catg_title" href="single_page.html"> Aliquam malesuada diam eget turpis varius</a> </div>--}}
{{--                                    </div>--}}
{{--                                </li>--}}
{{--                                <li>--}}
