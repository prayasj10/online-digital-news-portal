                    ...
                    <div class="single_page">
                        ...
                        <div class="single_post_content">
                            ...
                            @foreach($politics as $politic)
                                @foreach($politic->posts as $posts)
                                    ...
                                    @if($loop->even)
                                        <div class="single_post_content_left">
                                            ...
                                            <ul class="business_catgnav  wow fadeInDown">
                                                <li>
                                                    <figure class="bsbig_fig"><a href="/{{$politic->slug}}/{{$posts->id}}"
                                                                                 class="featured_img">
                                                            @if($posts->image)
                                                        ...
                                                        <figcaption><a
                                                                href="/{{$politic->slug}}/{{$posts->id}}">{{$posts->title}}</a>
                                                        </figcaption>
                                                        <p>{!!$posts->content!!}</p>
                                                    </figure>
                                                </li>
...
{{--                                                        href="/{{$politic->slug}}/{{$posts->id}}" class="media-left"> <img--}}
{{--                                                            alt="" src="{{$posts->image}}"> </a>--}}
{{--                                                    <div class="media-body"><a href="/{{$politic->slug}}/{{$posts->id}}"--}}
...
{{--                                    @if($post->id != $id)--}}
{{--                                        <li>--}}
{{--                                            <div class="media"> <a class="media-left" href="/{{$politic->slug}}/{{$post->id}}"> <img src="/{{$post->image}}" alt=""> </a>--}}
