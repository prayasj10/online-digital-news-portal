                ...
                <div class="left_content">
                    <div class="single_page">
                        ...
                        <div class="single_post_content">
                                    ...
                                    @if($loop->even)
                                        <div class="single_post_content_left">
                                            ...
                                            <ul class="business_catgnav  wow fadeInDown">
                                                <li>
                                                    <figure class="bsbig_fig"><a href="/{{$blog->slug}}/{{$posts->id}}"
                                                                                 class="featured_img">
                                                            @if($posts->image)
                                                        ...
                                                        <figcaption><a
                                                                href="/{{$blog->slug}}/{{$posts->id}}">{{$posts->title}}</a>
                                                        </figcaption>
                                                        <p>{!!$posts->content!!}</p>
                                                    </figure>
                                                </li>
                            ...
                            {{--                                                        href="/{{$blog->slug}}/{{$posts->id}}" class="media-left"> <img--}}
                            {{--                                                            alt="" src="{{$posts->image}}"> </a>--}}
                            {{--                                                    <div class="media-body"><a href="/{{$blog->slug}}/{{$posts->id}}"--}}
